                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Total Liter</th>
                                ...
                                @forelse ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{$item->attr_total_liter_format}}<br>
                                            <span class="badge badge-info">{{$item->attr_total_harga_format}}</span><br>
                                        </td>
                                        <td class="text-center">
                                            {{ $item->attr_tanggal_isi_format }}
                                        </td>
                                        <td class="text-center">

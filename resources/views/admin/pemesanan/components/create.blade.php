<div class="card-body">
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" id="tanggal_keberangkatan_at" name="tanggal_keberangkatan_at" class="form-control"
            onchange="dataDriver()">
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" id="tanggal_pulang_at" name="tanggal_pulang_at" class="form-control"
            onchange="dataDriver()">
    ...
    <div class="form-group">
        ...
        <select class="js-select2 select2-kendaraan" name="master_kendaraan_id" required>
            <option value="" disabled> Kendaraan Tidak Tersedia </option>
        </select>
